...
% inductance (H)
L0 = 1.2 * L_b; %Note: works good also for the combination L=.8Lb and C = 18e-3
% resistance (Ohm)
R0 = .1;   
...
%Paper equations, no N
eta = delta_wmax*(Vmax^2)/P_rated;
mu = 2*eta*Q_rated/(N*((2*Vmax^2-V0^2)^2-V0^4));
open("Mmc.slx")
